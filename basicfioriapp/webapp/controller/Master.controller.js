sap.ui.define([
	...
	return BaseController.extend("ns.basicfioriapp.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "ns.basicfioriapp.view.ViewSettingsDialog",
					controller: this
		...
		_updateListItemCount : function (iTotalItems) {
			...
			if (this._oList.getBinding("items").isLengthFinal()) {
				...
				var titletext = this.getView().byId("filterBarLabel");
				var titlecount = 'Business Partners ' + iTotalItems + '';
				titletext.setText('');
				titletext.setText(titlecount);
			}
		},
